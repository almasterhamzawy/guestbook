    ...
    $email   = filter_var($_POST['email'],FILTER_SANITIZE_EMAIL);
        ...
        if(strlen($name) < 3 ){
            ...
            $nameError = $errorMessage[] = 'you must add name';
                ...
                // edit by mark to check !(filter_var($email,FILTER_VALIDATE_EMAIL))
...
// edit by mark to check have error send message we have error not send data to data base
// and show succ. message
